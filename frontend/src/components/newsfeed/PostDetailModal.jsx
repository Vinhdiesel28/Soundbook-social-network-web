...
import { X, Heart, MessageCircle, Share2, MoreHorizontal, Send, Sparkles, ThumbsUp } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
             ...
             <div className="flex flex-col">
               <div className="flex items-center gap-2">
                  <h3 className="font-bold text-base leading-none">Bài viết của {livePost.user?.name}</h3>
                  {livePost.reason && (
